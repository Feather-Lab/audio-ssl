...
srun -K --cpu-bind=cores python3 lightning_scripts/train.py --config_path model_configs/kell18_barlow_equivariant_lmbda_1e-2_lr_2e-1_w_invar_augment_eq_lmbda_3e-01.yaml \
                                   --gpus $num_gpus --num_workers $SLURM_JOB_CPUS_PER_NODE \
                                   --exp_dir model_checkpoints \
                                   --resume_training 
