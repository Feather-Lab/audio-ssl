...
srun -K --cpu-bind=cores python3 lightning_scripts/train.py --config_path model_configs/barlow_word_kell2018_base_Matched_blocked_batches_lmbda_1e-1_no_schedule_lr_6e-1.yaml \
                                   --gpus $num_gpus --num_workers $SLURM_JOB_CPUS_PER_NODE \
                                   --exp_dir model_checkpoints \
                                   --resume_training 
