...
class AuditoryCNNMultiTask(nn.Module):
    ...
    def forward(self, x, with_latent=False, fake_relu=False, no_relu=False):
        ...
        if with_latent:
            return x_latent, x_latent, all_outputs
        return x_latent
        
       
def kell2018_ssl(pretrained=False, progress=True, **kwargs):
    ...
    model = AuditoryCNNMultiTask(**kwargs)
