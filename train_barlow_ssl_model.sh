...
srun -K --cpu-bind=cores python3 lightning_scripts/train.py --config_path model_configs/barlow_word_resnet18_base_Matched_blocked_batches_lmbda_1e-1_large_batch_longer_no_schedule.yaml \
