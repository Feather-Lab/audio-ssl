...
srun --cpu-bind=cores python3 lightning_scripts/train.py --config_path model_configs/word_speaker_audioset_resnet18_MatchedDataset_shuffle_one_gpu_LARS.yaml \
