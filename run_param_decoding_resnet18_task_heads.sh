...
#SBATCH --output=outLogs/param_decoding_task_head_%A_%a.out
#SBATCH --error=outLogs/param_decoding_task_head_%A_%a.err
...
srun -K python3 -u lightning_scripts/run_param_decoding_task_heads.py  \
                                   --config_list eval_config_manifests/resnet18_barlow_equivariant_param_decoding_config_list.pkl \
                                   --num_workers $SLURM_JOB_CPUS_PER_NODE \
                                   ...
                                   --num_train 50 \
                                   --ridge_alpha 0.5
                                  #  --equi_model_config model_configs/resnet18_barlow_equivariant_lmbda_1e-2_lr_2e-1_no_avgpool_eq_lmbda_1e-01.yaml \
