...
srun -K --cpu-bind=cores python3 -u lightning_scripts/train.py --config_path model_configs/mmcr_word_kell2018_Matched_blocked_batches_lmbda_1e-2_lr_2e-1_w_augment.yaml \
