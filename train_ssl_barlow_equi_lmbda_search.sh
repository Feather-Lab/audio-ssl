...
#SBATCH --output=outLogs/barlow_equivariant_lmda_search_kell2018_%A_%a.out
#SBATCH --error=outLogs/barlow_equivariant_lmda_search_kell2018_%A_%a.err
...
srun -K --cpu-bind=cores python3 lightning_scripts/train.py --config_list train_config_manifests/kell2018_barlow_equivariant_lmbda_search_w_augments.pkl \
